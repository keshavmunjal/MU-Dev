...
<head>
	...
	<!-- Page Title -->
	<title>Career Counselling and College Admission | Career Counsellor</title>
	...
	<!-- Stylesheet
	===================================================================================================  -->
	<link rel="stylesheet" href="<?php echo base_url ?>careerEdge/font/fontello.css">
	<link rel="stylesheet" href="<?php echo base_url ?>careerEdge/css/bootstrap.min.css">
	<link rel="stylesheet" href="<?php echo base_url ?>careerEdge/css/style.css">
	<link rel="stylesheet" href="<?php echo base_url ?>careerEdge/css/media-queries.css">
...
<!-- from meet univ -->
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
	  <meta name="description" content="MeetUniv provide career guidance , online counselling and college admission in the top colleges of US, UK, Canada, Singapore, Russia and Australia">
...
@font-face {
    ...
    src: url('roboto-slab.regular.eot?#iefix') format('embedded-opentype'),
         ...
         url('roboto-slab.regular.svg#roboto_slabregular') format('svg');
    font-weight: normal;
    font-style: normal;

}
#secondary_footer{background-color: #eaeaea;}
...
.price .pricely-paragraph {
    margin: 0px;
}
.list-group{margin-left:0px;}
.slider_testimonial .carousel-indicators li {border-radius: 50px;}
.slider_testimonial .carousel-indicators li.active {border-radius: 50px;}
.description{width:100%;}
.carousel-caption {background-color:rgba(255, 255, 255, 0);}
...
.video{background-color: #334452;
}
.video h4{color:white;}
.video h6{color:white;}
.description ul{margin-bottom: 40px;}	
.description ul li{
color: white;
font-size: 17px;
line-height: 28px;
		...
		<div class="banner">
		 <div class="row container">
            ...
            <a  href="http://meetuniv.com/" style="display:block; float:left"><img alt="Meet Univ" src="http://meetuniv.com/assets/img/meetuniv.png"></a>
			  ...
			  <nav id="top_menu" role="navigation" style="margin-left:0">
               <ul>
				  ...
				  <li><a href="https://meetuniv.com/course-search">Courses</a></li>
			...
			<div class="btn-group pull-right" style="margin-top:13px">
				<a href="http://meetuniv.com/login" class="btn btn-small">LOG IN</a>
				<a href="http://meetuniv.com/register" class="btn btn-small">SIGN UP</a>	
       		</div>
         </div>
		 </div>
		 <!---Navigation header---->
	    ...
	    <div class="navbar navbar-default Custommargin" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <!--<a class="navbar-brand" href="#"><img src="<?php echo base_url ?>careerEdge/img/logo.png" alt="logo brand"></a>-->
	        </div>
			
	        <div class="navbar-collapse collapse">
				<ul class="navbar-nav navbar-right" style="list-style:none;">
					<li><a href="http://meetuniv.com/careerEdge">Resume Writing</a></li>
					<li><a href="http://meetuniv.com/careerEdge/statement-of-purpose.php">Statement of Purpose</a></li>
					<li class="dropdown" id="resumeWriting">
				    <a href="#" <?php if($url[4] == 'premium-college-counselling.php'){?>id="active"<?php } ?> class="dropdown-toggle" data-toggle="dropdown">Ivy League Counselling<span class="caret"></span></a>
					...
					<li><a href="http://meetuniv.com/careerEdge/interview-tips.php">Interview Tips</a></li>
					<!--li><a href="#">Team</a></li>-->
                    ...
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="top:110px;">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="<?php echo base_url ?>careerEdge/img/ivy league counselling  .jpg" alt="First slide">
                            </div>
                            <!--<div class="item">
                                <img src="<?php echo base_url ?>careerEdge/img/slide2.png" alt="Second slide">
                            </div>
                            <div class="item">
                                <img src="<?php echo base_url ?>careerEdge/img/slide4.png" alt="Third slide">
                            </div>
							<div class="item">
                                <img src="<?php echo base_url ?>careerEdge/img/slide5.png" alt="Third slide">
                            </div>-->
                        </div>
...
left: 100px;font-size:40px;"><span style="font-size:18px;color:white;">PREMIUM COLLEGE COUNSELING</span> <hr/><p style="color:white;font-weight: bold;text-shadow: 0px 0px 12px #000000;font-size: 24px;">REMOVE YOUR DOUBTS AND CONFUSIONS WITH PREMIUM COLLEGE</p> <p style="color:white;font-weight: bold;text-shadow: 0px 0px 12px #000000;font-size: 24px;">COUNSELING TO BE IN THE BEST COLLEGE</p><br>
<a data-scroll-nav='3' style="cursor: pointer;"><img src="<?php echo base_url ?>careerEdge/img/button.png"></a>
<p style="font-size: 18px;font-weight: bold;margin-top: -46px;margin-left: 35px;"><a data-scroll-nav='3' style="cursor: pointer;color:white;">JUMP TO PRICING/DETAILS</a></p>
</article>
        ...
        <div class="container text-center" style="margin-top:75px;>
            <div class="row">
                <article class="item col-xs-12 ">
                    <a class="icon col-xs-12 col-lg-7" href="#"><img class="icon-monitor" src="<?php echo base_url ?>careerEdge/img/harvest-your-talent-in-the-best-talent.jpg" alt="//" style="width: 384px;"></a>
                    <div class="col-xs-12 col-lg-5 info_text">
                        <h2>Harvest your talent in the best college!</h2>
                        <p>
                            If you dream to be placed in the top colleges with your desired subject of study, get counseling on the premium colleges to select the best institution for yourself. Our Counselors can be your best guide at this time to remove your confusions regarding the selection of institutes. 
                        </p>
                        <a href="#" class="link">Check out our library <i class="icon-right-circled"></i></a>
                    </div>
                </article>
                <article class="item col-xs-12 ">
                    <a class="icon col-xs-12 col-lg-7 pull-right" href="#"><img class="icon-monitor" src="<?php echo base_url ?>careerEdge/img/Connect-with-premium-College.png" alt="//" style="width: 430px;"></a>
                    <div class="col-xs-12 col-lg-5 info_text">
                        <h2>Connect with premium College</h2>
                        <p>
                            If you want to study in one of the premium college and do not know how to connect with the institution, then with our counseling you may get in touch with one of the premium institution to fulfill your aim.
                        </p>
                        <a href="#" class="link">Compare pricing plans<i class="icon-right-circled"></i></a>
                    </div>
                </article>
                <article class="item col-xs-12 ">
                    <a class="icon col-xs-12 col-lg-7" href="#"><img class="icon-monitor" src="<?php echo base_url ?>careerEdge/img/Convert-your-dream-into-reality.png" alt="//"></a>
                    <div class="col-xs-12 col-lg-5 info_text">
                        <h2>Convert your dream into reality</h2>
                        <p>
                            If you want to realize all your dreams to come true, then here is a chance that we serve you to help and guide in the areas that you are in utter doubt and confusion.Grab this opportunity as fast as you can. 
                        </p>
	...
	<div class="container">
            <div class="row">
                <h2 class="col-lg-12" style="color:white">WHAT WE OFFER:</h2>
                <div class="description col-xs-12 col-lg-9">
                    <ul>
						<li>To land up in the best colleges of the world, we provide college counseling to aspirant student for studying abroad.</li>
						<li>Guidance related to career in MBA, college admissions are offered online by career Counselors and MBA counseling team of MeetUniv.</li>
						<li>With the online counseling, queries related to premium colleges are resolved by the Counseling experts.</li>
					</ul>
                </div>
               <!-- <div class="col-xs-12 col-lg-3">
				<form action="http://rezscore.com/a/34ad8b/grade" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-xs-12 console_video">
                    <div class="console col-xs-12">
                        <figure>
                            <img src="<?php echo base_url ?>careerEdge/img/bg-video.png" alt="//">
                        </figure>
                        <div class="vendor">
                    ...
                    <div class="slider_testimonial">
                        <div id="carousel-example-captions" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <figure>
                                        <img class="img-circle" src="<?php echo base_url ?>careerEdge/img/testimonials/testimonial1.jpg" alt="First slide image">
                                    </figure>
                                ...
                                <div class="item">
                                    <figure>
                                        <img class="img-circle" src="<?php echo base_url ?>careerEdge/img/testimonials/testimonial2.jpg" alt="gaSecond slide image">
                                    </figure>
                                ...
                                <div class="item">
                                    <figure>
                                        <img class="img-circle" src="<?php echo base_url ?>careerEdge/img/testimonials/testimonial3.jpg" alt="Third slide image">
                                    </figure>
                                    <div class="carousel-caption col-xs-12">
                                        <h4>Stephan Kendall</h4>
					...
					<div class="span2" style="width: 180px;">
						<ul class="nav nav-list">
						 <h5>Country Search
						  ...
						  <li><a href="http://meetuniv.com/study-in-uk-universities"> Study In UK</a></li>
						  <li><a href="http://meetuniv.com/study-in-usa-universities"> Study In USA</a></li>
						  <li><a href="http://meetuniv.com/study-in-australia-universities"> Study In Australia</a></li>
						  <li><a href="http://meetuniv.com/study-in-canada-universities"> Study In Canada</a></li>
						  <li><a href="http://meetuniv.com/study-in-singapore-universities"> Study In Singapore</a></li>
						  <li><a href="http://meetuniv.com/other-universities"> Other Countries </a></li>
					   </ul>
					</div>
					<div class="span2" style="width: 180px;">
						<ul class="nav nav-list">
						  ...
						  <li><a href="http://meetuniv.com/popular-college"> Popular Colleges</a></li>
						  <li><a href="http://meetuniv.com/contact-us?type=4"> Engineering Colleges</a></li>
						  <li><a href="http://meetuniv.com/contact-us?type=4"> MBA Colleges</a></li>
						  <li><a href="http://meetuniv.com/contact-us?type=4"> Top Ranked Colleges</a></li>
					   </ul>
					</div>
					<div class="span2" style="width: 180px;">
						<ul class="nav nav-list">
						 <h5>Career Edge
						  ...
						  <li><a href="http://meetuniv.com/gifted-intro"> Career Chooser Stream </a></li>
						  <li><a href="http://meetuniv.com/learn/edurator/browse-ieltspreparation-videos-1-date.html?type=4"> IELTS Videos </a></li>
					   </ul>
					</div>
					<div class="span4" style="margin-bottom: 10px;">
					<div style="float:left;width:100%;height:auto;margin-top: 14px;margin-left: 40px;">
						<div class="green">
						  <p class ="custom_font" style="color:white;">  Call Us</p>
						  <h1 class="custom_head">1800-300-00068</h1>
						  <p class ="custom_font" style="margin-top: 5px;margin-left: -5px;"><span style="margin-left: 7px;margin-right: 7px;padding-left: 6px;"><img src="http://meetuniv.com/careerEdge/img/cal.png"></i></span> <span class="monfont" style="color:white;">Mon - Fri </span><span style="margin-left: 7px;margin-right: 7px;"><img src="http://meetuniv.com/careerEdge/img/time.png"></span><span  class="monfont" style="color:white;">9AM - 6PM</span></p>
						  </div>
						  <div class="yellow">
						  <h1 class="redhead"> 90,000 + </h1>
						  <p class="red_stu"><img src="http://meetuniv.com/assets/img/student.png"></p>
						  </div>
						  ...
						  <div class="green_font">CONNECT</div>
								...
								<div style="float:left;height:auto;width:100%"> <p style="text-align:center;"><img src="http://meetuniv.com/assets/img/house1.png" style="height: 35px;"></p></div>
						  </div>
						  </div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-4">
							<ul class="inline footer_icons">
  								<li><a href="https://www.facebook.com/Meetuniv"><span><img src="http://meetuniv.com/assets/img/fb.png" ></span></i></a></li>
								<li><a href="https://twitter.com/MeetUniv">
								<span><img src="http://meetuniv.com/assets/img/tw.png" ></span></a></li>
								<li><a href="http://www.youtube.com/MeetUniv"><span><img src="http://meetuniv.com/assets/img/yt.png" ></span></a></li>
  							</ul> 
  						</div>
  						<div class="col-lg-8">

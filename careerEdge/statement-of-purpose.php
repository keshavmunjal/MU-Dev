...
<head>
	...
	<!-- Page Title -->
	<title>Statement of Purpose - Samples and Format from Expert to write a SOP </title>
...
<!-- from meet univ -->
      ...
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
	  <meta name="description" content="For admission in the graduate schools, statement of purpose is a vital requirement to convice selection team. Check our format and sample to writing a winning SOP.">
	      ...
	      <div class="container">
	        ...
	        <div class="navbar-collapse collapse">
				<ul class="navbar-nav navbar-right" style="list-style:none;">
				    ...
				    <a href="#" <?php if($url[4] == 'statement-of-purpose.php'){?>id="active"<?php } ?> class="dropdown-toggle" data-toggle="dropdown">Statement of Purpose <span class="caret"></span></a>
					...
					<li><a href="http://meetuniv.com/careerEdge/premium-college-counselling.php">Ivy League Counselling</a></li>
                ...
                <div class="bs-example">
                    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="top:110px;">
                        ...
                        <div class="carousel-inner">
                            <div>
                                <img src="<?php echo base_url ?>careerEdge/img/statement of purpose.jpg" alt="First slide">
                            </div>
                            <!--<div class="item">
...
left: 100px;font-size:40px;"><span style="font-size:18px;color:white;">STATEMENT OF PURPOSE</span> <hr/><p style="color:white;font-weight: bold;text-shadow: 0px 0px 12px #000000;font-size:24px;">SUBHEADMING: WRITE ENGAGING, HITH IMPACT ESSAYS THAT TELL</p> <p style="color:white;font-weight: bold;text-shadow: 0px 0px 12px #000000;font-size:24px;">THE ADMISSIONS COMMITTEE WHO ARE AND WHY YOU ARE</p> <p style="color:white;font-weight: bold;text-shadow: 0px 0px 12px #000000;font-size:24px;">A PERFECT FIT FOR THE PROGRAM OF YOUR CHOICE</p><br>
...
<p style="font-size: 18px;font-weight: bold;margin-top: -46px;margin-left: 35px;"><a data-scroll-nav='3' style="cursor: pointer;color:white;">JUMP TO PRICING/DETAILS</a></p>
        ...
        <div class="container text-center" style="margin-top:75px;>
            <div class="row">
                <article class="item col-xs-12 ">
                    <a class="icon col-xs-12 col-lg-7" href="#"><img class="icon-monitor" src="<?php echo base_url ?>careerEdge/img/expert-critique.jpg" alt="//" style="width: 360px;"></a>
                    <div class="col-xs-12 col-lg-5 info_text">
                        <h2>Get an expert critique</h2>
                        <p>
                            Let our seasoned editors review your work for clarity, style, correctness, and flow. These factors are as important as the content of your essays. All our editors have outstanding educational and professional ackgrounds and significant experience in working with college aspirants and will guide you towards achieving your goals through your words. 
                        </p>
                        <a href="#" class="link">Check out our library <i class="icon-right-circled"></i></a>
                    </div>
                </article>
                <article class="item col-xs-12 ">
                    <a class="icon col-xs-12 col-lg-7 pull-right" href="#"><img class="icon-monitor" src="<?php echo base_url ?>careerEdge/img/Have-your-essays-proofread-by-native-English-speakers.jpg" alt="//" style="width: 366px;"></a>
                    <div class="col-xs-12 col-lg-5 info_text">
                        <h2>Have your essays proofread by native English speakers</h2>
                        <p>
                            The final proofreading of your essays is done by native English speakers, who will ensure that your work is 100% error-free.
                        </p>
                        <a href="#" class="link">Compare pricing plans<i class="icon-right-circled"></i></a>
                    </div>
                </article>
                <article class="item col-xs-12 ">
                    <a class="icon col-xs-12 col-lg-7" href="#"><img class="icon-monitor" src="<?php echo base_url ?>careerEdge/img/use-our-help-start-to-end.jpg" alt="//" style="width: 385px;"></a>
                    <div class="col-xs-12 col-lg-5 info_text">
                        <h2>Use our help start to finish!</h2>
                        <p>
                            If you are short of time and need our help to brainstorm for writing ideas, discuss buying a full package with your counselor and get our help throughout the essay writing process.
                        </p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="description col-xs-12 col-lg-9">
                    <p>
                        Creative writing is a process. Once you understand the process, you will find it surprisingly simple to
						create compelling and engaging personal essays. Download our free essay writing guide to start writing like experts.
                    </p>
                </div>
                ...
                <div class="col-xs-12 console_video">
                    <div class="console col-xs-12">
                        ...
                        <div class="vendor">
							<iframe width="570" height="350" src="//www.youtube.com/embed/TdGmga4SmzA" frameborder="0" allowfullscreen></iframe>
	...
	<section data-scroll-index='2' class="testimonial generic" style="padding-top:11%">
        <div class="container">
            <div class="row text-center">
                <div class="col-sm-12">
                    <h2>Your Feedback</h2>
                    <p style="color:#334452">We could talk for hours about how good we are and efficient
	...
	<section data-scroll-index='3' class="price generic" style="padding-top:11%">
        <div class="container text-center">
            <div class="row">
                <h2>Pricing Table</h2>
                <p style="color:#334452">We could talk for hours about how good we are and efficient but your opinion will always be the truest and most important.
                        ...
                        <ul class="pricely-pro">
                            <li class="pricely-first-heading panel-default col-md-3">
                                <div class="panel-heading">
                                    ...
                                    <p class="pricely-foreword" style="color: #8495a5;">Select your plan</p>
                                    <p class="pricely-paragraph" style="color: #8495a5;"><span class="icon-calendar"></span></p>
                                    <p class="pricely-paragraph" style="color: #8495a5;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum primis.</p>
                                </div>
                                <ul class="list-group">

...
<body>
	      ...
	      <div class="container">
	        ...
	        <div class="navbar-collapse collapse">
	          <ul class="nav navbar-nav navbar-right">
	            <li class="active"><a href="#menu-slider">Resume Writing</a></li>
	            <li><a href="#menu-features">Statement of Purpose</a></li>
	           <!-- <li><a href="#menu-information">Classes</a></li>
	            <li><a href="#menu-countdown">Countdown</a></li>-->
	            <li><a href="#menu-price">Premium College Counselling</a></li>
	            <li><a href="#menu-testimonial">Interview Tips</a></li>
	...
	<section id="menu-features" class="features">
        ...
        <article class="item text-center">
            <div class="panel-heading">
               <h3 class="sub_title">
                   <a id="learn-from-anywhere" href="#menu-video">what we offer</a>
               </h3>
            </div>
        ...
        <article id="notes-from-the-tacher" class="item text-center">
            <div class="panel-heading">
                <h3 class="sub_title">
                    <a href="#menu-logos">notes from the tacher</a>
                </h3>
            </div>
           <!-- <div class="panel-body">
                <a href="#" class="content_info">
        ...
        <article class="item text-center">
            <div class="panel-heading">
                <h3 class="sub_title">
                    <a href="#menu-testimonial">testimonial</a>
                </h3>
            </div>
           <!-- <div class="panel-body">
                <a href="#" class="content_info">
	...
	<!-- Video -->
	<section id="menu-video" class="video generic" style="padding-top:11%">
        <div class="container">
            <div class="row">
                <h2 class="col-lg-12">WHAT WE OFFER:</h2>
                <div class="description col-xs-12 col-lg-9">
                    <p>
                        Dental schools, medical schools, nursing schools, residency programs, pharmacy programs, veterinary schools, and related programs all share one thing in common: an extraordinarily competitive application process. Give yourself an edge with personalized admissions writing guidance from the Harvard, Yale, and other Ivy-League graduate editors at EssayEdge.
                    </p>
                </div>
	...
	<!-- Logos -->
	<section id="menu-logos" class="logos generic" style="padding-top:11%">
        <div class="container">
	...
	<!-- Testimonials -->
	<section id="menu-testimonial" class="testimonial generic" style="padding-top:11%">
        <div class="container">
            <div class="row text-center">
                <div class="col-sm-12">
                    <h2>Your Feedback</h2>
	...
	<!-- Pricing Table -->
	<section id="menu-price" class="price generic" style="padding-top:11%">
        <div class="container text-center">
            <div class="row">
                <h2>Pricing Table</h2>
	...
	<!-- Contact-->
	<section id="menu-contact" class="contact generic" style="padding-top:11%">
        <div class="container text-center">
            <div class="row">
                <div class="col-sm-12">
...
$(document).ready(function(){
	// $('#learn-from-anywhere').click(function(){
		// $('#menu-video').css('margin-top','11%');
	// });
});
</script>

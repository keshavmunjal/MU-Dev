<?php /* Smarty version 2.6.20, created on 2015-03-13 14:09:59
         compiled from featured_video.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'featured_video.tpl', 100, false),)), $this); ?>
...
: <?php echo $this->_tpl_vars['voth_title']; ?>
			...
			<p style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;"> <?php echo $this->_tpl_vars['voth_description']; ?>
</p>
			<ul>
 ...
 <?php echo $this->_tpl_vars['lang']['_likes']; ?>
			...
			<?php endforeach; endif; unset($_from); ?>
				...
				<span style="margin-left:200px;">
						<?php if ($this->_tpl_vars['page_numbers']['total'] > 1): ?>
						(page <?php echo $this->_tpl_vars['page_numbers']['current']; ?>
 / <?php echo $this->_tpl_vars['page_numbers']['total']; ?>
)&nbsp;&nbsp;

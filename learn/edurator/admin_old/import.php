...
<button class="btn btn-small border-radius0" data-toggle="button" id="list"><i class="icon-th"></i> </button>
<button class="btn btn-small border-radius0" data-toggle="button" id="stacks"><i class="icon-th-list"></i> </button>
</div>
<?php
}
?>
...
if($_POST['submit'] == 'Import' && ($action == 'import'))
{
	...
	$info_msg = '<div class="alert alert-success">Imported <strong>'.$imported_total.'</strong> out of <strong>'.$total_videos.'</strong> videos.';
...
<div class="video-stack" id="stackid-[<?php echo $counter;?>]">
	...
	<div class="on_off" rel="tooltip" title="Click if you wish to import this video. Green indicates the video has been selected.">
	...
	<ul class="thumbs_ul_import">
                    ...
                    <span class="stack-video-duration"><?php echo sec2min($yt_length); ?></span>
                    <span class="stack-preview"><a href="http://www.youtube.com/v/<?php echo $id; ?>&autoplay=1&v=<?php echo $id; ?>" rel="prettyPop[flash]" title="<?php echo $title; ?>"><img src="img/ico-playbutton.png" /></a></span>
    ...
    <label>
    <input type="checkbox" name="featured[<?php echo $counter;?>]" id="check_ignore" value="1" /> <small>Mark as <span class="label label-info">FEATURED</span></small>
    </label>
	...
	?>
            ...
            <button type="submit" name="submit" class="btn btn-success" value="Import" id="submitImport" data-loading-text="Importing...">Import <span id="status"><span id="count">0</span></span> videos </button>
            </div><!-- #stack-controls -->
		</div><!-- #vs-grid -->
        <?php

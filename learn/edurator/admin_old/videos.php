...
{
	echo "<div class=\"alert alert-success\">Comment(s) removed successfully.</div>";
}
...
<div class="tablename">
<h6><?php if (!empty($filter)) { ?><button type="button" id="" class="btn btn-link btn-mini btn-danger" onClick="parent.location='videos.php'">Remove filter</button><?php } ?>
<?php if (!empty($_POST['keywords'])) { ?>SEARCH RESULTS FOR "<em><?php echo $_POST['keywords']; ?></em>"<?php } ?></h6>
    <div class="pull-right">
...
<div class="row-fluid">
<div class="span4">
    <form name="search" action="videos.php" method="post" class="form-search" onsubmit="return validateSearch('true');">
    <div class="input-append">
    <input name="keywords" type="text" value="<?php echo $_POST['keywords']; ?>" size="30" class="search-query search-quez span7" placeholder="Enter keyword" />
...
<div class="btn-group input-prepend">
  ...
  ?>
  <button type="button" id="appendedInputButtons" class="btn btn-danger" onClick="parent.location='videos.php'">Remove filter</button>
  <?php } else { ?>
  ...
  <?php } ?>
      ...
      {
          ?>
           <a href="videos.php?action=9" class="btn btn-danger" rel="tooltip" title="Remove ALL videos?">Delete all videos</a>
          <?php
      }
      ?>
 ...
 <table cellpadding="0" cellspacing="0" width="100%" class="table table-striped table-bordered pm-tables tablesorter">
  <thead>
   <tr>
    ...
    <th width="90" style="width: 90px;">Action</th>
   </tr>
  </thead>
  <tbody>
	<?php echo $videos; ?>
	<tr><td colspan="11" class="tableFooter"><div class="pagination pull-right"><?php echo $pagination; ?></div></td></tr>
  </tbody>
 </table>
...
<div class="btn-toolbar">
    <div class="btn-group">
    <button type="submit" name="Submit_restrict" value="Restrict access" class="btn btn-small btn-link" rel="tooltip" title="Make selected videos <u>private</u>. They will only be available to registred users." /><img src="img/ico-locked.png" width="12" height="16" /></button>
    <button type="submit" name="Submit_derestrict" value="Derestrict access" class="btn btn-small btn-link" rel="tooltip" title="Make selected videos <u>public</u>. Remove any viewing restrictions." /><img src="img/ico-unlocked.png" width="12" height="16" /></button>
    </div>
    
	<div class="btn-group">
    <input type="submit" name="Submit" value="Mark as featured" class="btn btn-mini btn-blueish" />
    <input type="submit" name="Submit" value="Mark as regular" class="btn btn-mini" /> 
    </div>

	<div class="btn-group">
    <input type="submit" name="VideoChecker" id="VideoChecker" value="Check status" class="btn btn-mini btn-success" onclick="javascript: return false;" />
    <input type="submit" name="Submit" value="Delete checked" class="btn btn-mini btn-danger" onClick="return confirm_delete_all();" />

  ...
  <div id="import_user">
	...
	if($youtube_mirror[0]['OPENSEARCH:TOTALRESULTS'] != 0)
	{
        ...
        <div class="video-stack" id="stackid-[<?php echo $counter;?>]">
            <div style="font-size: 10px; font-weight: normal" rel="tooltip" title="Click if you wish to import this video. Green indicates the video has been selected.">
            <div class="on_off">
            ...
            <ul class="thumbs_ul_import">
                ...
                <span class="stack-preview"><a href="http://www.youtube.com/v/<?php echo $yt_id; ?>&autoplay=1&v=<?php echo $yt_id; ?>" rel="prettyPop[flash]" title="<?php echo $title; ?>"><img src="img/ico-playbutton.png" /></a></span>

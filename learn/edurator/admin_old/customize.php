...
$default_tpl_properties = array(
	...
	'ct_header' 		=> '#f9f9f9',		//	.wide-header: background-color
	...
	'ct_sitetitle' 		=> '#005580',		//	h1.site-title a: color
...
if ($_POST['action'] == 'customize-save') // AJAX
{
	...
	echo json_encode(array('success' => true,
							'msg' => '<div class="alert alert-success"><strong>Saved!</strong> Return to the <a href="settings_theme.php">Admin Area</a> or <a href="'._URL.'/index.'._FEXT.'">see your website</a>.</div>'
						  ));
...
$preview_page = preg_replace('/<a(.*)href="([^"]*)"(.*)>/','<a$1href="javascript:alert(\'This is not accessible during the customization process.\');"$3>',$preview_page);
	...
	<tr>
		<td colspan="2">
			<ul class="pager ct_submit">
				<li class="previous">
					<button id="button-cancel" class="btn btn-small border-radius3">
						&larr; Cancel
					</button>
				</li>
				<li class="next">

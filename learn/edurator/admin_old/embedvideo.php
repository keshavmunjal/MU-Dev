...
if ($_POST['submit'] != '')
{
	...
	{
		$return_msg = 'You forgot to paste in the embed code.';
	}
	...
	if ($return_msg == '')
	{
		...
		do {
			...
			else
			{
				...
				$step = 3;
				$return_msg = '<strong>SUCCESS!</strong> The video has been added to your database.';
				}
			}
			while(false);
		}
...
<div class="container row-fluid" id="post-page">
    ...
    -->
    <textarea name="embed_code" id="must" rows="4" style="width: 98%"><?php echo $inputs['embed_code']; ?></textarea>

...
//-- MySQL Settings --//
/** MySQL database name */
$db_name = 'meetuniv_video';

/** MySQL database username */
$db_user = 'mu_development';

/** MySQL database password */
$db_pass = 'mudev2015!';

/** MySQL hostname */
$db_host = 'mu-development.ccbae3jhwwnq.us-west-2.rds.amazonaws.com';

// Full URL without any trailing slash (e.g http://www.example.com)
define('_URL', 'http://meetuni.com/learn/edurator');	
define('_URLARTICLE', 'http://meetuni.com/learn/blog');	///PATH FOR ARTICLE

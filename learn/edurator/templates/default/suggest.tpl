        ...
        <form class="form-horizontal" id="suggest-form" name="suggest-form" method="post" action="{$form_action}">
          <fieldset>
            ...
            <div class="hide" id="suggest-video-extra">
                ...
                <div class="">
                  <div class="controls">
                    <input class="btn btn-success" name="Submit" id="Submit" value="{$lang.submit_submit}" type="submit" data-loading-text="{$lang.submit_send}"> <span class="hide" id="loading-gif-bottom"><img src="{$smarty.const._URL}/templates/{$template_dir}/img/ajax-loading.gif" width="" height="" alt=""></span>
                  </div>
                </div>

<ul class="breadcrumb" style="padding-top: 6%;margin-bottom: -140px;font-size: 13px;background: none;border-bottom: none;color: #cecece;padding-left: 17%;">
                  <li ><a href="https://meetuniv.com/">Home</a> <span class="divider"><i class="icon-arrow-right" style="opacity: 0.2;"></i></span></li>
					...
					<li class="active">{$gv_category_name}</li>
					
</ul>
{include file='header.tpl' p="general" rss="video-category"} 
<h1 class="entry-title compact" style="margin-left: 240px;margin-top: 65px;font-size: 35px;">{$gv_category_name}</h1>
<div class="video-banner-row" style="margin-top: 16px;">
		...
		<div class="pull-left right-text">
			...
			<ul style="list-style: none;margin-left: 0;margin-top: 28px;">
				...
				<li><a href="#"><img src="{$smarty.const._URL}/templates/default/images/arrow.jpg">Watch More Videos</a></li>-->
				<!--<li><a href="#"><img src="{$smarty.const._URL}/templates/default/images/arrow.jpg">More Lorem & Ipsum</a></li>-->
			</ul>
		</div>
			...
			{foreach from=$results key=k item=video_data}
			  <li>
				<div class="pm-li-video">
				    ...
				    <a href="{$video_data.video_href}" class="pm-thumb-fix pm-thumb-145"><span class="pm-thumb-fix-clip"><img src="{$video_data.thumb_img_url|replace:'http':'https'}" alt="{$video_data.attr_alt}" width="145"><span class="vertical-align"></span></span></a>
				    </span>
				    ...
				    <p class="pm-video-attr-desc">{$video_data.excerpt|replace:'http':'https'}</p>

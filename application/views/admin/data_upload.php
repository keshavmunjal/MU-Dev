...
<span id="message" style="color:red;margin-left:540px;"></span><br /><br />
	<form id="univName" class="form-horizontal" name="univName" method="post" action="<?php echo base_url('admin/view');?>" enctype="multipart/form-data">
		<tr>
			
			<td >Upload US College Data</td>
		</tr>
...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js"></script> 
    ...
    <script> 
       $("#univName").submit(function(){
		...
		window.location.href='<?php echo base_url()?>admin/view/'+univId;
		return false;

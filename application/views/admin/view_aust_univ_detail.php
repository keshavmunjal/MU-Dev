...
<?php } ?>
<div style="margin-left:650px;font-weight:bold;margin-top:10px;font-size: 15px;color: blue;">UK University</div>
<div style="margin-left:630px;font-weight:bold;margin-top:10px;font-size: 13px;"><?php echo $univData[0]['univName']; ?></div>
	...
	<form id="univName" class="form-horizontal" name="univName" method="post" action="" enctype="multipart/form-data">
		...
		<tr>
			...
			<td>
			 	<input type="text" name="featured" value="<?php echo $univData[0]['featured']; ?>" class="input-text">
			</td>
			<td>
				Intake
			</td>
		...
		<tr>
			...
			<td>
			 	<input type="text" name="linkedin" value="<?php echo $univData[0]['rss']; ?>" class="input-text">
			</td>
		</tr>
		<tr>
			...
			<textarea name="address" rows="4" cols="5" class="input-text">
					<?php echo $univData[0]['address']; ?>
				</textarea> 
			 	</td>
		...
		<tr>
			...
			<td>
				<?php 
				if($univData[0]['slider']){ ?>
				<img src="<?php echo base_url()?>assets/img/<?php echo $univData[0]['slider'];?>" alt="<?php echo $univData[0]['univName'];?>" title="<?php echo $univData[0]['univName'];?>" style="max-width: 70px;margin: 11px 4px;" class="img-polaroid"></img>
					<input type="hidden" value="<?php echo $univData[0]['slider'];?>" name="slider">
				<?php } ?>
			</td>
			<td>
				Contact Number
			...
			<td>
			 	<input type="text" name="contact" value="<?php echo $univData[0]['contacts'];?>" class="input-text">
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
			 	<input type="file" name="logo" value="" class="input-text">
			</td>
			<td>
				<?php 
				if($univData[0]['logo']){ ?>
				<img src="<?php echo base_url()?>assets/univ_logo/<?php echo $univData[0]['logo'];?>" alt="<?php echo $univData[0]['univName'];?>" title="<?php echo $univData[0]['univName'];?>" style="max-width: 70px;margin: 11px 4px;" class="img-polaroid"></img>
					<input type="hidden" value="<?php echo $univData[0]['logo'];?>" name="univ_logo">
				<?php } ?>
			</td>
			...
			<td>
			 	<input type="text" name="youtube_video" value="<?php echo $univData[0]['youtube_video_id'];?>" class="input-text">
			</td>

            ...
            <div class="span6">
                <form class="form-horizontal">
                    ...
                    <div class="input-prepend">
						...
						<input type="hidden" id="Detailtype" value="">
...
<div class="modal-body">
    <form action="https://localhost/mu/register" method="post" accept-charset="utf-8" id="registerForm">				<div class="control-group">
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><img src="https://localhost/mu/assets/img/student_name.png"></span>
				...
				<div class="control-group">
					<div class="controls">		
						<div class="input-prepend">
							<span class="add-on"><img src="https://localhost/mu/assets/img/mail.png"></span>
				...
				<div class="control-group">
					<div class="controls">	
						<div class="input-prepend">
							<span class="add-on"><img src="https://localhost/mu/assets/img/Mobile.png"></span>
				...
				<div class="control-group">
					<div class="controls">	
						<div class="input-prepend">
							<span class="add-on"><img src="https://localhost/mu/assets/img/Password.png"></span>
				...
				<div class="control-group">
					<div class="controls">
						<div class="input-prepend">
							<span class="add-on"><img src="https://localhost/mu/assets/img/Confirm-Password.png"></span>
               ...
               <div class="row clearfix" id="collage_listing_page">
				  ...
				  <div class="row">
					 ...
					 <article class="span3">
                      ...
                      <!--<article><a target="_blank" href="https://meetuniv.com/Study-In-UK-Top-Universities.php?campaign=0&src=home" style="text-decoration:none;text-align:centre"><img title="Northumbria University Event in India" alt="Northumbria University Event in India" src="<?php echo base_url();?>assets/img/ad/nu600.jpg"></a></article>-->
					  <article>
					  <!--<a target="_blank" href="https://bit.do/hpbannernew" style="text-decoration:none;text-align:centre"><img title="British Council Survey" alt="British Council Survey" src="<?php echo base_url();?>assets/img/ad/bcsurvey.jpg"></a>
					  <a target="_blank" href="https://meetuniv.com/Study-In-Uk-Meet-Sixty-Universities.php" style="text-decoration:none;text-align:centre"><img title="British Council Events" alt="British Council Events" src="<?php echo base_url();?>assets/img/ad/bcevent.jpg"></a>-->
					  <!--<a target="_blank" href="https://meetuniv.com/course/Northumbria-University/597/Applied-Sport-and-Exercise-Science/21FSES-N-ASE1" style="text-decoration:none;text-align:centre"><img title="Unistat verified Course Stats" alt="Unistat verified Course Stats" src="<?php echo base_url();?>assets/img/ad/stats.jpg"></a>-->
					  </article>
					</article><br/><br/>
                  </div>
				  </article>
...
<script>
					...
					$(document).ready(function(){
						...
						$('#locationFilter').typeahead({
							...
							source: function(query, process){
								 ...
								 return $.get('<?php echo base_url()?>connect/cityJsonList',function(data){
	 ...
	 <script>
		...
		function ConnectMU(connectId,univName,eventName,eventDate,eventPlace,type)
		{
		//alert(univName);
		...
		function sendConnectSms()
		{
			...
			var data = {name:fullname,email:email,phone:phone,type:type,connectId:connectId}
		...
		function attendEventvedio(id)
		{
			...
			var xmlhttp;
						...
						if(xmlhttp.responseText!="loggedIn")
							{
								...
								var person = prompt("Please verify your mobile number to get the event details");
					 				
									if (person == xmlhttp.responseText) {
									
											var rates = document.getElementsByName('tslot');
										var rate_value;
										for(var i = 0; i < rates.length; i++){
											if(rates[i].checked){
												timeslot = rates[i].value;
											}
										}
										...
										if(valid == true)
										{
											var evenData = {name:$('#name-'+id).val(),phone:$('#phone-'+id).val(),email:$('#email-'+id).val(),connectId:connectId,tslot:timeslot,type:'register'};
											$.ajax({
											type: "POST",
											url: "<?php echo base_url('connect/attendEvent')?>",
											data: evenData,
				...
				xmlhttp.open("GET","<?php echo base_url('connect/ankit')?>?a="+mobile,true);
				xmlhttp.send();

				  ...
				  <div class="thumbnail" style="padding: 0;line-height:12px;">
					...
					<div class="caption" style="padding:0px 9px;">
					  ...
					  <p id="eventLocation" class="edit-move-left">
						...
						<i class="icon icon-map-marker" style="padding:0px"></i> <span id="address">Place, Country</span>
					  </p>
					</div>
...
<div class="modal-body">
    ...
    <div class="modal-footer">
	  ...
	  <script>
		...
		function ConnectMU(connectId,univName,eventName,eventDate,eventPlace,address)
		{

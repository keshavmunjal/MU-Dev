						...
						<article class="span7">
						  <div class="row">
						   ...
						   <div class="span6">
							<div class="row">
								<div class="span4">
									<h4><a style="text-decoration:none" href="<?php echo base_url().strtolower($universities->countryName).'-college/'.$universities->univName.'/'.base64_encode($universities->id)?>"><?php echo $universities->univName; ?></a></h4>
								</div>
								<div class="span2">
...
$("[rel=tooltip]").tooltip({ placement: 'bottom'});		 
 $(document).ready(function(){
		...
		$("#pagination a").click(function(){
			...
			var temp = url.split('/');
			var data = {offset:temp[6],countryName:$("#filtrationCountries").val()};
			$.ajax({
				type	:	'POST',
				data	:	data,
				url		:	url,
